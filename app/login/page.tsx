  ...
  return (
    <main className="flex min-h-dvh w-full flex-col items-center justify-center px-4 py-10 sm:py-14">
      <section
        ...
        className="w-full max-w-md overflow-hidden rounded-xl border border-border bg-card shadow-[var(--shadow-subtle)]"
      >
        <div className="lms-grid-pattern relative overflow-hidden bg-primary px-6 py-8 text-white sm:px-8">
